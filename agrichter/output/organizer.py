"""File organization utilities for AgRichter output management."""
...
class FileOrganizer:
    ...
    def get_figure_path(self, crop_type: str, figure_type: str, 
        ...
        Args:
            ...
            figure_type: Type of figure ('agrichter_scale', 'hp_envelope', 'production_map', 'balance_timeseries')
        ...
        figure_names = {
            'agrichter_scale': f'AgRichterScale_{crop_type.title()}',
