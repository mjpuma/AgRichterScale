"""Advanced reporting system for AgRichter analysis."""
...
class AnalysisReporter:
    ...
    def _generate_executive_summary(self, analysis_data: Dict[str, Any], 
        ...
        lines.append(f"risks for {crop_type} using the AgRichter Scale methodology.")
        lines.append("")
    ...
    def _generate_methodology_section(self, crop_type: str) -> List[str]:
        ...
        lines.append("The AgRichter Scale analysis employs the following methodology:")
        lines.append("")
