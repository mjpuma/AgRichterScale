"""Main data processing module for AgRichter framework."""
...
class DataProcessor(BaseProcessor):
    """Main data processor for AgRichter analysis."""
    ...
    def __init__(self, config: Config):
        ...
        """
        self.config = config
        self.logger = logging.getLogger('agrichter.processor')
    ...
    def create_processing_report(self, results: Dict[str, pd.DataFrame]) -> str:
        ...
        report_lines = [
            "=" * 60,
            "AgRichter Data Processing Report",
            "=" * 60,
