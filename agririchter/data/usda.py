"""USDA PSD data loader and threshold calculator for AgriRichter analysis."""
...
class USDADataLoader:
    ...
    def get_crop_mapping(self) -> Dict[str, str]:
        """
        Get mapping from AgriRichter crop types to USDA crop names.
        
        Returns:
            Dictionary mapping AgriRichter names to USDA names
        """
        return {
            'wheat': 'wheat',
            'rice': 'rice', 
...
class AgriPhaseThresholdCalculator:
    ...
    def convert_sur_to_production_thresholds(self, crop: str, sur_thresholds: Dict[int, float], 
        ...
        # Based on the original AgriRichter scale values (1e14 to 1e16 kcal range)
