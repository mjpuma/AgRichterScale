"""Unit conversion utilities for AgriRichter framework."""
...
class UnitConverter:
    """Handles all unit conversions for AgriRichter analysis."""
    ...
    def __init__(self, config: Config):
        ...
        """
        self.config = config
        self.logger = logging.getLogger('agririchter.converter')
    ...
    def convert_magnitude_to_harvest_area(self, magnitude: Union[pd.Series, np.ndarray, float]) -> Union[pd.Series, np.ndarray, float]:
        """
        Convert AgriRichter magnitude back to harvest area in km².
    ...
    def convert_harvest_area_to_magnitude(self, harvest_area_km2: Union[pd.Series, np.ndarray, float]) -> Union[pd.Series, np.ndarray, float]:
        """
        Convert harvest area in km² to AgriRichter magnitude.
    ...
    def create_conversion_report(self, original_data: pd.DataFrame, 
        ...
        report_lines = [
            "=" * 50,
            "AgriRichter Unit Conversion Report",
            "=" * 50,
