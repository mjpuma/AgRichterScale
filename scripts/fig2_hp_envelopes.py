...
def main():
    ...
    try:
        ...
        legend_elements = [
            mlines.Line2D([0], [0], color='black', lw=2, label='Upper Bound', alpha=0.8),
            mlines.Line2D([0], [0], color='blue', lw=2, label='Lower Bound', alpha=0.8),
        ...
        plt.savefig(results_dir / 'figure2_hp_envelopes.png', dpi=300, bbox_inches='tight', facecolor='white')
