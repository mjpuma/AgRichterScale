    ...
    def __init__(self, config):
        ...
        self.label_overrides = {
            'allgrain': {
                ...
                'PotatoFamine': (0.05, 10**15.2),        # Highest
                'DustBowl': (0.05, 10**14.7),            # Below Irish  
                'NorthKorea1990s': (0.05, 10**14.2),     # Below Dust Bowl
                'Bangladesh': (0.05, 10**13.7),          # Below N. Korea
                'MillenniumDrought': (0.05, 10**13.2),   # Below Bangladesh (added)
                
                # Middle area
                'Ethiopia': (2.0, 10**14.4),             # Middle, raised
                'ENSO2015_2016': (3.2, 10**15.1),        # Middle right, raised
                
                # Upper right - spread vertically
                'ChineseFamine1960': (4.5, 10**15.9),    # Highest
                'SovietFamine1921': (5.8, 10**15.5),     # High, moved left
                'Drought18761878': (6.5, 10**15.1),      # Below Soviet
                'SahelDrought2010': (5.2, 10**14.3),     # Middle right
                
                # Lower right
                'Syria': (4.8, 10**13.0),                # Lower right
            },
            'wheat': {
                'GreatFamine': (0.3, 10**14.5),          # Left, raised
                'DustBowl': (2.5, 10**14.1),             # Middle
                'Ethiopia': (1.5, 10**13.5),             # Left middle
                'SahelDrought2010': (3.0, 10**13.0),     # Middle
                'Syria': (4.0, 10**13.8),                # Middle right
                'MillenniumDrought': (4.8, 10**14.4),    # Right middle
                'SovietFamine1921': (5.5, 10**14.5),     # Upper right
                'Drought18761878': (6.3, 10**15.0)       # Highest, right edge
            },
            'maize': {
                'Haiti': (1.0, 10**14.2),                # Left (added)
                'GreatFamine': (1.8, 10**14.0),          # Left  
                'Ethiopia': (3.0, 10**13.5),             # Middle (added)
                'SovietFamine1921': (3.8, 10**13.2),     # Middle
                'DustBowl': (4.2, 10**15.0),             # Upper middle, raised
                'SahelDrought2010': (4.8, 10**14.7),     # Upper middle right
                'ChineseFamine1960': (5.5, 10**15.5),    # Upper right, raised
                'ENSO2015_2016': (5.8, 10**14.9),        # Upper right, below China
            },
            'rice': {
                'Solomon': (0.8, 10**11.5),              # Lower left, lowered
                'EastTimor': (2.2, 10**14.2),            # Left middle, raised
                'Laos': (2.5, 10**13.5),                 # Left middle
                'Liberia': (3.5, 10**12.8),              # Middle
                'Bangladesh': (3.8, 10**14.1),           # Middle, raised
                'SierraLeone': (4.5, 10**13.5),          # Middle right
                'ENSO2015_2016': (5.5, 10**15.2),        # Upper right
                'ChineseFamine1960': (5.8, 10**14.8),    # Upper right, below El Niño
                'Drought18761878': (6.2, 10**15.6),      # Highest, right
            }
        }
